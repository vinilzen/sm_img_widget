...
var widget_container='<div class="smw__img_widget">',tpl='<div id="<%=id%>" class="smw__item"><div class="smw__imgl"><a href="<%=url%>" target="_blank"><img src="<%=img_url%>" title="<%=title%>" alt="<%=title%>" /></a></div><div class="smw__imgdescr"><h3><a href="<%=url%>" target="_blank"><%=title%></a></h3><p><a href="<%=url%>">от <strong><%=priceMin%></strong> руб.</a></p><p class="smw__offer"><a href="<%=url_all%>" target="_blank">все предложения (<%=count%>)</a></p></div></div>',powered='<div class="smw__powered">Powered by <a href="#">SocialMart</a> Данные - <a href="#">Яндекс.Маркет</a></div>',test_data=[{id:1,img_url:"img/1.jpg",title:"Samsung Galaxy Tab 2 7.0 P3110 8Gb",url:"http://dva-cveta.ru/index.php?route=product/product&path=59&product_id=188&_openstat=bWFya2V0LnlhbmRleC5ydTtOb2tpYSBMdW1pYSA3MTA7dTN0em82Q01xbFVtZ3J5VS1RbmhCZzs",url_all:"http://dva-cveta.ru/index.php?route=product/product&path=59&product_id=188&_openstat=bWFya2V0LnlhbmRleC5ydTtOb2tpYSBMdW1pYSA3MTA7dTN0em82Q01xbFVtZ3J5VS1RbmhCZzs",price:"25 600",priceMin:"25 600",count:25},{id:2,img_url:"img/2.jpg",title:"Apple iPhone 5S 16Gb",url:"http://dva-cveta.ru/index.php?route=product/product&path=66&product_id=156",url_all:"http://dva-cveta.ru/index.php?route=product/product&path=66&product_id=156",price:"28 300",priceMin:"28 300",count:32}];$(function(){function t(t){var e=t.closest("center").length?t.closest("center"):t.closest("div");if(e.css({position:"relative"}),t.widget)return!1;t.widget=$(widget_container).appendTo(e).width(o).attr("data-leave",1);var a=t.offset().left-e.parent().offset().left;return t.widget.css({left:a}),test_data.forEach(function(e){t.widget.append(tmpl(tpl,e))}),console.log("show"),t.widget.append(powered).mouseleave(function(){function e(){t.widget&&"1"===t.attr("data-leave")&&"1"===t.widget.attr("data-leave")&&t.widget.fadeOut("200",function(){t.widget.remove(),delete t.widget})}t.widget.attr("data-leave",1),setTimeout(e,500)}).mouseenter(function(){$(this).attr("data-leave",0)}).css({bottom:0}),!0}var e=".add_widget",a=240,i=100,d=.4,r=$(e),o=(r.position(),r.outerWidth()),l=r.height();o>a&&l>i*d?r.hover(function(){$(this).attr("data-leave",0),t(r)&&r.widget.fadeIn()},function(){function t(){r.widget&&"1"===r.attr("data-leave")&&"1"===r.widget.attr("data-leave")&&r.widget.fadeOut("200",function(){r.widget.remove(),delete r.widget})}r.attr("data-leave",1),setTimeout(t,500)}):console.log("слишком маленькое изображение")});