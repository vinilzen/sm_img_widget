...
$.noConflict(),jQuery(document).ready(function(e){function t(t){var a=e(t),o=(a.position(),a.outerWidth()),d=a.height();o>m&&d>r*_?a.hover(function(){e(this).attr("data-leave",0),i(a)&&a.widget.fadeIn()},function(){function e(){a.widget&&"1"===a.attr("data-leave")&&"1"===a.widget.attr("data-leave")&&a.widget.fadeOut("200",function(){a.widget.remove(),delete a.widget})}a.attr("data-leave",1),setTimeout(e,500)}):console.log("слишком маленькое изображение",o,d,m,r*_)}function i(t){var i=t.closest("center").length?t.closest("center"):t.closest("div");if(i.css({position:"relative"}),t.widget)return!1;t.widget=e(o).appendTo(i).width(t.outerWidth()).attr("data-leave",1);var n=t.offset().left-i.parent().offset().left;return t.widget.css({left:n}),t.outerWidth()<450&&(e(".smw__item").width("100%"),e(".smw__img_widget").css({height:"inherit"})),model_data.forEach(function(e){t.widget.append(tmpl(d,e))}),console.log("show"),t.widget.append(s).mouseleave(function(){function e(){t.widget&&"1"===t.attr("data-leave")&&"1"===t.widget.attr("data-leave")&&t.widget.fadeOut("200",function(){t.widget.remove(),delete t.widget})}t.widget.attr("data-leave",1),setTimeout(e,500)}).mouseenter(function(){e(this).attr("data-leave",0)}).css({bottom:0}),a(),!0}function a(){void 0!==mixpanel&&mixpanel.track("smwi widget hit",{url:document.URL})}var o='<div class="smw__img_widget">',d='<div class="smw__item"><div class="smw__imgl"><a href="<%=url%>" target="_blank"><img src="<%=mainPhoto%>" title="<%=name%>" alt="<%=name%>" /></a></div><div class="smw__imgdescr"><h3><a href="<%=url%>" target="_blank"><%=name%></a></h3><p><a href="<%=url%>">от <strong><%=priceMin%></strong> руб.</a></p><p class="smw__offer"><a href="<%=url%>" target="_blank">все предложения (<%=offersCount%>)</a></p></div></div>',s='<div class="smw__powered">Powered by <a href="#">SocialMart</a> Данные - <a href="#">Яндекс.Маркет</a></div>',n=".smw__img_widget{display:none;position:absolute;width:100%;left:0;background-color:#fff;overflow:hidden;padding:0}.smw__img_widget .smw__item{min-width:225px;width:50%;float:left;padding-top:10px;padding-bottom:3px}.smw__img_widget .smw__item .smw__imgl{float:left;max-width:80px;padding-right:10px;padding-left:10px;text-align:center}.smw__img_widget .smw__item .smw__imgl img{max-width:80px;max-height:73px}.smw__img_widget .smw__imgdescr{margin-left:66px;padding-right:18px;text-align:left}.smw__img_widget .smw__imgdescr h3{margin:0;padding:0 0 3px 0;font-family:Arial;font-size:13px;display:inline-block;max-height:32px;overflow:hidden}.smw__img_widget .smw__imgdescr h3 a{text-decoration:none;font-weight:bold;font-size:13px;color:#000}.smw__img_widget .smw__imgdescr h3 a:hover{color:#444}.smw__img_widget .smw__imgdescr p{margin:0;padding:0;font-size:12px;font-family:Arial;margin-top:-4px}.smw__img_widget .smw__imgdescr p a{text-decoration:none;color:#000}.smw__img_widget .smw__imgdescr p.smw__offer a{font-size:12px;font-family:Arial;color:#33a8d3;text-decoration:none}.smw__img_widget .smw__imgdescr p.smw__offer a:hover{text-decoration:underline}.smw__img_widget .smw__imgdescr p strong{color:#33a8d3;font-size:20px;font-weight:bold;font-family:Arial}.smw__img_widget .smw__imgdescr p.smw__offer{color:#33a8d3}.smw__img_widget .smw__powered{width:100%;height:10px;font-size:8.5px;color:#838383;font-family:Arial;float:left;text-align:right;padding-bottom:6px}.smw__img_widget .smw__powered a{text-decoration:none;font-size:8.5px !important;color:#33a8d3}.smw__img_widget .smw__powered a:last-child{padding-right:10px}.smw__img_widget .smw__powered a:hover{text-decoration:underline}",m=240,r=100,_=.4;e("head link[rel='stylesheet']").last().after('<style media="screen" type="text/css">'+n+"</style>"),e("head").append(e("<link/>",{href:swmi?smwi.cssLinkPath:"css/style.css?v="+Math.round(+new Date/1e3),rel:"stylesheet"})),e.getJSON("http://socialmart.ru/?json=2",function(e){model_data=e.models[0],"string"==typeof e.selector?t(e.selector):"object"==typeof e.selector&&e.selector.length>0&&e.selector.forEach(function(i,a){model_data=e.models[a],t(i)})})});